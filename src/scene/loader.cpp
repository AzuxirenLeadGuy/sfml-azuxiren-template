...
auto Loader::Load(SfmlGameClass & /*unused*/) -> int { return 0; }

auto Loader::PollEvent(SfmlGameClass & /*unused*/, sf::Event /*unused*/) -> int { return 0; }

auto Loader::Update(SfmlGameClass & /*unused*/, const long /*unused*/) -> Loader::UpdateResult
{
	return Loader::UpdateResult{0, nullptr};
}

auto Loader::Destroy(SfmlGameClass & /*unused*/) -> int { return 0; }
